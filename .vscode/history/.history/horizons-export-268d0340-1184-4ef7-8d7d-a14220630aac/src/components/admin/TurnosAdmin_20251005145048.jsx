              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0">
                <div className="flex-1">
                  ...
                  <p className="text-gray-700 font-semibold">
                    {turno.usuarios ? `${turno.usuarios.nombre} ${turno.usuarios.apellido}` : 'Cliente no encontrado'}
                  </p>
                  {turno.usuarios?.email && (
                    <p className="text-gray-500 text-sm">{turno.usuarios.email}</p>
                  )}
                  {isEditing ? (

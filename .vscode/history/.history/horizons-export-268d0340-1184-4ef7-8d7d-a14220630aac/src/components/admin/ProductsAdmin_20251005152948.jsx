        ...
        <div className="flex space-x-3">
          {editingId ? (
            <>
              ...
              <Button onClick={() => { setEditingId(null); setFormData({ nombre: '', descripcion: '', precio_actual: '', stock: '', imagen: '' }); }} variant="outline"><X className="w-4 h-4 mr-2" />Cancelar</Button>
            </>
          ) : (
            <Button onClick={handleAdd} className="bg-gradient-to-r from-red-700 to-red-500"><Plus className="w-4 h-4 mr-2" />Agregar Producto</Button>
          )}
        </div>
      </motion.div>

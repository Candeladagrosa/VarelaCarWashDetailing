...
import { Sparkles, Calendar, ShoppingBag, Star, Droplet } from 'lucide-react';
    ...
    <>
      ...
      <div className="min-h-screen">
        <section className="relative overflow-hidden py-20 px-4">
          <div className="absolute inset-0 bg-gradient-to-br from-red-700/10 via-gray-700/10 to-black/10" />
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            >
              <motion.div
                ...
                className="inline-flex items-center space-x-2 bg-gradient-to-r from-red-700 to-red-900 text-white px-6 py-3 rounded-full shadow-lg"
              >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Button
                  ...
                  size="lg"
                  className="bg-gradient-to-r from-red-700 to-red-900 hover:from-red-800 hover:to-red-950 text-lg px-8 py-6 shadow-xl"
                >
                  Reservar Turno
                </Button>
                <Button
                  ...
                  size="lg"
                  variant="outline"
                  className="text-lg px-8 py-6 border-2 border-red-700 hover:bg-red-50"
                >
                  Ver Productos
                </Button>
              </div>
        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto">
            <motion.div
              ...
              viewport={{ once: true }}
              className="glass-effect rounded-3xl p-12 text-center bg-gradient-to-br from-red-700/10 to-gray-700/10"
            >
              ...
              <Button
                onClick={() => navigate('/services')}
                size="lg"
                className="bg-gradient-to-r from-red-700 to-red-900 hover:from-red-800 hover:to-red-950 text-lg px-12 py-6 shadow-xl"
              >
                Reservar Ahora
              </Button>
            </motion.div>
